...
//Funções
         ...
         function atirar(){
         	...
         	if(podeAtirar==true){
         		...
         		setTimeout(() => {avatarJogador.src = "./img/ryu.gif";}, 500);
         	}
         }
         ...
         function colisaoInimigo(){
            ...
            function atirarInimigo(){
         	...
         	if (random() >= 50) {
         		...
         		setTimeout(() => {avatarInimigo.src = "./img/akuma.gif";}, 500);
         		}
         	}
         }
         ...
         function mensagemResetarEscore() {
         	...
         	setTimeout(() => {fundo.removeChild(mensagemResetarEscore);}, 500);
         }
         function mensagemDerrota() {
         	...
         	setTimeout(() => {fundo.removeChild(mensagemDerrota);}, 2000);
         };
         function mensagemVitoria() {
         	...
         	setTimeout(() => {fundo.removeChild(mensagemVitoria);}, 2000);
         };
